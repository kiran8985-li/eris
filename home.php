                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      <blockquote><p>Welcome to Path-Finder, your ultimate campus placement management platform 
                        dedicated to shaping futures and connecting opportunities. Our mission is to revolutionize the way 
                        students find their ideal careers by seamlessly integrating with educational institutions, employing 
                        smart matching algorithms, and providing an engaging user experience. For students, Path-Finder offers 
                        the tools to build compelling profiles and discover opportunities that align with their goals. 
                        Recruiters benefit from simplified campus recruitment processes, 
                        access to a pool of talented individuals, and data-driven insights. 
                        Join us in redefining the future of education and employment Path-Finder, 
                        where opportunities and aspirations converge for a seamless journey from campus to career.</p></blockquote>
